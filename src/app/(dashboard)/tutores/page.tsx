...
import { mockTutores, mockAlumnos } from '@/lib/data/mock-data';
import { formatFecha } from '@/lib/utils/business-rules';
import type { Tutor } from '@/lib/types/database';
import '../shared.css';

export default function TutoresPage() {
    const [tutores, setTutores] = useState<Tutor[]>(mockTutores);
    ...
    const getHijosCount = (tutorId: string) => {
        return mockAlumnos.filter(a => a.tutor_id === tutorId).length;
    };
        ...
        <>
            <div className="page-header">
                <div>
                    ...
                    <p className="page-subtitle">Padres y tutores de los alumnos</p>
                </div>
            ...
            <div className="stats-grid" style={{ marginBottom: 'var(--space-4)' }}>
                ...
                <div className="stat-card">
                    <div className="stat-value">{mockAlumnos.filter(a => a.tutor_id).length}</div>
